...
class ToolsPanel extends JPanel implements ItemListener, KeyListener, ActionListener {
	Gui gui;
	private Quest quest;
	...
	TextArea speech;
	JList note;
	DefaultListModel noteData = new DefaultListModel(); 
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource()==wandering) {
			...
			if (note.getSelectedValue() != null) {
				int response = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete this note?","Confirm Delete",JOptionPane.YES_NO_OPTION);
