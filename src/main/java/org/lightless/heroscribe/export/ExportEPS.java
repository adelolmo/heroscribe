...
public class ExportEPS {
	...
	public static void write(File file, Quest quest, List objects)
		...
		bBoxWidth = (quest.getWidth() * (quest.getBoard(0, 0).getWidth() + 2) +
			(quest.getWidth() - 1) * objects.getBoard().adjacentBoardsOffset) * 19.2f; //612.0f ;

		bBoxHeight = ((quest.getHeight() * (quest.getBoard(0, 0).getHeight() + 2) +
			(quest.getHeight() - 1) * objects.getBoard().adjacentBoardsOffset) * 19.2f) + 400; //792.0f + (400*(quest.getHeight()-1));
	...
	public static void writeMultiPage(File file, Quest quest, List objects)
	throws Exception {
	PrintWriter out =
		new PrintWriter(new BufferedWriter(new FileWriter(file)));
	TreeSet set = new TreeSet();
	...
	// HSE - set the box height to accommodate quest text 
	bBoxWidth = (quest.getBoard(0, 0).getWidth() + 2 +
		objects.getBoard().adjacentBoardsOffset) * 19.2f; 

	bBoxHeight = ((quest.getBoard(0, 0).getHeight() + 2 +
		objects.getBoard().adjacentBoardsOffset) * 19.2f) + 400;
